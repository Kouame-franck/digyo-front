...
export default function PolitiqueConfidentialite() {
  return (
    <>
      <Seo
        title="Politique de confidentialité | digyo"
        description="Politique de confidentialité de digyo : comment nous collectons, utilisons et protégeons vos données personnelles."
          ...
          <div className="mt-12 space-y-10 text-sm leading-relaxed text-ink/80">
            <div>
              ...
              <p className="mt-3">
                ...
                <br />
                <LegalPlaceholder>DIGYO</LegalPlaceholder>, société de
                droit ivoirien immatriculée sous le n° RCCM{" "}
                <LegalPlaceholder>[__]</LegalPlaceholder>, dont le siège social est situé{" "}
                <LegalPlaceholder>[__]</LegalPlaceholder>, {contactInfo.city}
                . Voir aussi nos{" "}
            ...
            <div>
              ...
              <p className="mt-3">
                ...
                {" "}— <LegalPlaceholder>[__]</LegalPlaceholder>.
              </p>
            </div>
          </div>
